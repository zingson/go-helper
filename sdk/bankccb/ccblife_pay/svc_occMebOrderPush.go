...
func MebOrderPush(conf *Config, args *OrderPushParams) (v OrderPushBody, err error) {
	return Call[OrderPushBody](conf, conf.ServiceSvcjson, "svc_occMebOrderPush", args)
}
...
type OrderPushParams struct {
	...
	RefundStatus   string      `json:"REFUND_STATUS"`    //Y 退款状态 0-无退款  1-退款申请 2-已退款 3-部分退款
