...
type Config struct {
	...
	AcctEntityTp  AccEntityTp `json:"acct_entity_tp"` //默认03 营销活动配置的赠送维度（参见营销平台活动配置），2位， 可选：01=手机 02-卡号 03-用户（二选一） 赠送维度为卡号时，则cardNo必填； 赠送维度为用户时，则openId，mobile, cardNo三选一上送
}
